...
- Accepted case ids: `["tm-v1-diag-window-find-form-marker", "tm-v1-form-summary", "tm-v1-checkbox-true", "tm-v1-button-inert", "tm-v1-table-items", "tm-v1-group-main"]`
...
| tm-v1-diag-window-find-form-marker | diagnostic_window_find_form_marker | diagnostic_window_find_form_marker | ok | True | joined | zero_width_expanded_to_1s | {"from": 22, "to": 24, "count": 3} | {"from": 23, "to": 25, "count": 3} |  | accepted_probe | True |
...
| tm-v1-form-summary | form_summary | form_summary | ok | True | joined | zero_width_expanded_to_1s | {"from": 365, "to": 367, "count": 3} | {"from": 366, "to": 368, "count": 3} |  | accepted_probe | True |
| tm-v1-checkbox-true | element_state | element_state | ok | True | joined | zero_width_expanded_to_1s | {"from": 368, "to": 372, "count": 5} | {"from": 369, "to": 373, "count": 5} |  | accepted_probe | True |
| tm-v1-button-inert | element_state | element_state | ok | True | joined |  | {"from": 373, "to": 1020, "count": 648} | {"from": 374, "to": 1020, "count": 647} |  | accepted_probe | True |
| tm-v1-table-items | table_summary | table_summary | ok | True | joined | zero_width_expanded_to_1s | {"from": 1025, "to": 1030, "count": 6} | {"from": 1026, "to": 1031, "count": 6} |  | accepted_probe | True |
| tm-v1-group-main | group_summary | group_summary | ok | True | joined | zero_width_expanded_to_1s | {"from": 1031, "to": 1036, "count": 6} | {"from": 1032, "to": 1037, "count": 6} |  | accepted_probe | True |
