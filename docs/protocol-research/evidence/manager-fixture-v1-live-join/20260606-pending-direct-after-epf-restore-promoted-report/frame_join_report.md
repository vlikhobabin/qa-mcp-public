...
- Accepted case ids: `["tm-v1-active-window", "tm-v1-active-form", "tm-v1-diag-window-find-field-marker", "tm-v1-diag-form-find-field-marker", "tm-v1-field-version", "tm-v1-field-string", "tm-v1-checkbox-true", "tm-v1-commandbar-main", "tm-v1-pages-main"]`
...
| tm-v1-checkbox-true | element_state | element_state | ok | True | joined | zero_width_expanded_to_1s | {"from": 126, "to": 130, "count": 5} | {"from": 127, "to": 131, "count": 5} |  | accepted_probe | True |
