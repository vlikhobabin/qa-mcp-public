...
- Capture id: `20260602-172319`
- Capture dir: `C:\Users\historical-user\YandexDisk\Work\dev-mcp-1c\qa-mcp\runtime\protocol-research\captures\20260602-172319`
- Case count: `10`
- Case rows: `docs/protocol-research/evidence/corpus/20260602-172319-expanded-readonly/corpus_cases.jsonl`
- Case events: `runtime/protocol-research/captures/20260602-172319/case_events.jsonl`

## Case Rows

| case | family | availability | api call | manager frames | request bytes | response bytes | hash prefix | replay | markers |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| active-window-context |  | supported | TestedApplication.GetActiveWindow + TestedClientApplicationWindow read-only properties | {"from": 8, "to": 11} | 400 | 995 | 62e03d159d511173 | accepted | 7 |
| active-form-context |  | supported | TestedApplication.GetActiveForm + TestedForm read-only metadata | {"from": 12, "to": 17} | 801 | 2337 | e43ce48cedae7b6d | accepted | 14 |
| form-element-details | EditField | supported | TestedForm.FindObject/GetChildObjects + form element read-only property probes | {"from": 101, "to": 106} | 1200 | 972 | b56da7520da52418 | accepted | 1 |
| typed-input-field-readonly | EditField | supported | TestedForm.FindObject/GetChildObjects + typed input EditField read-only property probes | {"from": 101, "to": 106} | 1200 | 972 | b56da7520da52418 | accepted | 1 |
