# qa-mcp publication policy

## Purpose

Bind the exact Apache-2.0 public-source policy, audited-snapshot history
boundary, public contacts and published OSS-07-I2 prerequisite.
