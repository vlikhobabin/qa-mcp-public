# qa-mcp-private-fenced-seam Specification

## Purpose

Define the private clean-HEAD liveness/inventory fence, bounded pre-receipt
diagnostic ownership and transferred-observer hold that protect the two hidden
direct-execute worker inventory boundaries without adding public, wire,
mutation, retry, fallback or live authority.
