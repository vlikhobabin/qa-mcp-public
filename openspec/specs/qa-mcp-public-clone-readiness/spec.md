# qa-mcp public clone readiness

## Purpose

Define the isolated public-source snapshot proof and complete offline
verification floor required before review and publication.
