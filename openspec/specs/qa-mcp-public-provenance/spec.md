# qa-mcp public provenance

## Purpose

Define the exhaustive redistribution ledger and fail-closed disclosure checks
for public qa-mcp source snapshots while preserving the published OSS-07-I2
safety oracle.
## Requirements
