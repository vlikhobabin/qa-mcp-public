# qa-mcp public repository documentation

## Purpose

Define the discoverable public source guide, standard project policies,
pre-release boundary and offline-valid local documentation links.
