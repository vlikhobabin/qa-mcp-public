# qa-mcp-session1-metadata-restoration-authority Specification

## Purpose

Define the typed, privacy-safe investigation boundary and the session-0-owned
restoration handoff required before S4-R1 may seek another confirmation.
