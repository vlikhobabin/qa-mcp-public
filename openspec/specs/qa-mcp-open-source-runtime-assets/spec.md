# qa-mcp Open Source Runtime Assets Specification

## Purpose

Define the readable, key-free package and curated-asset contract shared by
standalone qa-mcp and downstream AI for 1C consumers.
