# qa-mcp-private-inventory-classifier-payload-authorization Specification

## Purpose

Define the exact non-reusable, documentation-only ChangeRail authorization
source prepared by published I7 for the one bounded private inventory
classifier successor.
