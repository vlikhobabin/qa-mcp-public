# qa-mcp-standalone-host-bridge Specification

## Purpose
Define the open, independently deployable Windows bridge contract used by the
standalone qa-mcp container for owned TestClient lifecycle, authenticated relay
and bounded lifecycle-targeted display operations.
## Requirements
