# qa-mcp-hidden-direct-execute-investigation-decision Specification

## Purpose

Define the published, exact-lineage and non-admitting decision that constrains
the bounded hidden direct-execute successor train.
