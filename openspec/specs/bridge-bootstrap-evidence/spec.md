# bridge-bootstrap-evidence Specification

## Purpose
Define the offline and supervised Windows evidence required to accept team
bridge bootstrap, including attribution across refresh/restart, secret-free
retention, an approved read-only provider probe and exact owned cleanup.
