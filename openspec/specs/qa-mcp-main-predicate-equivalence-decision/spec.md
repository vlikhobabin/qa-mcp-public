...
Define the closed offline predicate-equivalence, predecessor-invariant and
bounded successor-authorization decision required before another private
hidden main-inventory classifier implementation attempt.
