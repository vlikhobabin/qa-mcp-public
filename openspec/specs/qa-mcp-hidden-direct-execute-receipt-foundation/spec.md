# qa-mcp-hidden-direct-execute-receipt-foundation Specification

## Purpose

Define the dormant internal cross-language receipt, immutable current-run
cleanup binding and single-use stop lease for the published hidden direct-
execute chain without activating any public route.
