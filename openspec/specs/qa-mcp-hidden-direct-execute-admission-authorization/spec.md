# qa-mcp-hidden-direct-execute-admission-authorization Specification

## Purpose

Define the published, bounded and non-transferable ChangeRail authorization
that permits only the final hidden direct-execute successor to exceed the
ordinary production-size guard and declare its backward-compatible wire
capability.
