# qa-mcp-private-fenced-seam-publication-decision Specification

## Purpose
Define the privacy-safe offline decision boundary for whether the private
fenced S4 seam can be published independently for later classifier work.
