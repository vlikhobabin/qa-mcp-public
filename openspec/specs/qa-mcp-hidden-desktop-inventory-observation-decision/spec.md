# qa-mcp Hidden-Desktop Inventory Observation Decision

## Purpose

Define the evidence limit, sole behavior-neutral classifier successor,
hostile verification oracle and fail-closed authority ceiling for the consumed
S4-R1 first-inventory refusal.
